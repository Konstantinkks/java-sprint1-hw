/*
Я, честно говоря, не до конца уверен, что правильно понял зачем нужен цикл в конструкторе.
Как я это понимаю. Мы создали поле MonthData[] monthToData = new MonthData[12], здесь мы указали
кол-во элементов в массиве. А в конструкторе цикл создает 12 экземпляров MonthData, правильно?
 */
